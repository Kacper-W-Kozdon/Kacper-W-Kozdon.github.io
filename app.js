...
function showJobDetail(id){
  ...
  document.getElementById('dt-match-chips-plus').innerHTML=matches.map((e)=>`<div class="match-pill-text" style="display: inline-flex; align-content: center; align-items: center; border: 1px; background: #B8DFC0; color: #28A35A; borderColor: #28A35A">
    <div class="cs-icon material-symbols-outlined" style="color: #28A35A;">thumb_up</div><div>${e}</div>
  </div>`).join('');
  document.getElementById('dt-match-title-minus').textContent=`Warto mieć na uwadze`;
  document.getElementById('dt-match-chips-minus').innerHTML=mismatches.map((e)=>`<div class="match-pill-text" style="display: inline-flex; align-content: center; align-items: center; border: 1px; background: #F0BABA; color: #C83232; borderColor: #C83232">
    <div class="cs-icon material-symbols-outlined" style="color: #C83232;">thumb_down</div><div>${e}</div>
  </div>`).join('');
