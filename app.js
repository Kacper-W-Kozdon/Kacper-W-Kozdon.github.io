...
function showJobDetail(id){
  ...
  document.getElementById('dt-match-chips-plus').innerHTML=matches.map((e)=>`<div class="match-pill" style="height: auto; width: auto; gap: 8px; padding: 6px 16px; border-color: #28A35A; display: inline-flex; align-items: center; background: #B8DFC0; color: #28A35A; borderColor: #28A35A">
  ...
  document.getElementById('dt-match-chips-minus').innerHTML=mismatches.map((e)=>`<div class="match-pill" style="height: auto; width: auto; gap: 8px; padding: 6px 16px; border-color: #C83232; display: inline-flex; align-items: center; background: #F0BABA; color: #C83232; borderColor: #C83232">
